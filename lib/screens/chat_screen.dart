...
import 'package:shieldlink/features/chat/models/models.dart';
    ...
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 8.0),
        ...
        children: const [
          ...
          _MessageTile(
            message: 'Do you want to go get StarBucks?',
            messageDate: '12:02 PM',
          ),
          _MessageOwnTile(
            message: 'Sure, I am in!',
            messageDate: '12:03 PM',
          ),
          _MessageTile(
            message: 'I will meet you there in 10 minutes',
            messageDate: '12:03 PM',
          ),
          _MessageOwnTile(
...
class _AppBarTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Avatar.small(
          url: messageData.profileProfile,
        ),
        const SizedBox(
          width: 16,
        ),
